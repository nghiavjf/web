...
$chuoi = "";
	...
	$mang_duy_nhat2=implode(", ", $mang_duy_nhat);
}


?>

	<form action="demmang.php" method="POST">
		<table border="0">
			<thead>
				<tr>
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="so_lan_xuat_hien"  disabled="disabled" value="<?php echo $chuoi; ?>"  ></td>
				</tr>
				<tr>
					<td>Mảng duy nhất:</td>
					<td><input type="text" name="mang_duy_nhat" disabled="disabled" value="<?php echo $mang_duy_nhat2; ?>"></td>
				</tr>
				<tr>
					<td colspan="1"><input type="submit" value="Thực hiện"/></td>
				</tr>
			</tbody>
		</table>
	</form>
