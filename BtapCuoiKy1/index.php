...
<body style="background: url(images/br.jpg);">
<?php
...
?>
	...
	<div class="copy-right py-3" style="margin-bottom: -50px;">
		<div class="container">
			<p class="text-center text-white">© 2021 TLN Book Store. All rights reserved | Design by VNGHIA - HNGHIA - HAO
			</p>
		</div>
	</div>
	<!-- //copyright -->
