<?php
	...
	$sql_cate = mysqli_query($mysqli,"select * from loaiodo,odo where odo.trangthai='1' and loaiodo.maloaio = odo.maloaio and loaiodo.maloaio='$id' order by odo.maodo");
	$sql_category = mysqli_query($mysqli,"select * from loaiodo,odo where loaiodo.maloaio = odo.maloaio and loaiodo.maloaio='$id' order by odo.maodo");
	$row_title= mysqli_fetch_array($sql_category);
	$title=$row_title["tenloaio"];		

?>
<!-- top Products -->
<div class="ads-grid py-sm-5 py-4" style="margin-top: -50px;">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem" >
										...
										<div class="item-info-product text-center border-top">
                                                <h4 class="pt-1" style="height: auto;">
                                            ...
                                            <fieldset>
                                                ...
                                                <input type="hidden" name="giasanpham" value="<?php echo $row_sanpham['dongia'] ?>" />
